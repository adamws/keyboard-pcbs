...
[layout](prime_e_rgb-kle.json) - [PCB](prime_e_rgb.kicad_pcb)

![prime_e_rgb-layout.png](prime_e_rgb-layout.png){:loading="lazy"}
...
![prime_e_rgb-render.svg](prime_e_rgb-render.svg){:loading="lazy"}
