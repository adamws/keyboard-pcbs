...
[layout](meridian-kle.json) - [PCB](meridian.kicad_pcb)

![meridian-layout.png](meridian-layout.png){:loading="lazy"}
...
![meridian-render.svg](meridian-render.svg){:loading="lazy"}
